...
import { ArrowUpRight, Crown, GraduationCap, Plane, Briefcase, Sparkles } from 'lucide-react';
...
const tabs = [
  ...
  },
  {
    ...
    label: 'Visa & Finance',
    icon: Plane,
    keys: ['Visa Services', 'Health Insurance', 'Travel Insurance', 'Blocked Account Assistance'],
  },
  {
    id: 'settlement',
    label: 'Settlement',
  ...
  },
  {
    ...
    label: 'Career',
    icon: Briefcase,
    keys: ['Career Preparation', 'Internship Guidance', 'Student Job Assistance', 'Investment Guidance'],
  },
  {
    id: 'premium',
    label: 'Premium',
...
export function Services() {
  ...
  return (
    <section id="services" className="relative overflow-hidden bg-slate-50 py-20 dark:bg-primary-950/50 sm:py-28">
        ...
        <Reveal>
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-500 dark:text-slate-400 sm:text-base">
              From your first consultation to landing a job in Germany, we handle every milestone with expert precision.
            </p>
          </div>
        </Reveal>
                ...
                <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
                  <div>
                    ...
                    <ul className="mt-5 space-y-2">
                      {['Personal Germany roadmap tailored to your profile', 'University shortlist strategy and program fit', 'Visa timeline and document prep walkthrough', 'Career path and job market insights'].map((pt) => (
                        <li key={pt} className="flex items-center gap-2.5 text-sm text-primary-100">
                ...
                {tabServices.map((service, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-semibold text-ink dark:text-white">{service.title}</p>
                      <p className="mt-1 text-xs leading-relaxed text-slate-500 dark:text-slate-400">{service.description}</p>
                    </div>
