...
export default function ServicesPage() {
  ...
  useEffect(() => { document.title = 'Services - StudyingGermany.de'; }, []);
    ...
    <main className="min-h-screen bg-canvas pt-28 pb-24 dark:bg-primary-950">
      <div className="container-page">
        <SectionHeading
          ...
          title={<>Everything for your journey, <span className="heading-gradient">under one roof</span></>}
          ...
          {services.map((service, i) => (
            <Reveal key={service.title} delay={(i % 3) * 0.07}>
              ...
              >
                ...
                <h3 className="mt-5 font-heading text-base font-semibold text-ink dark:text-white">{service.title}</h3>
                <p className="mt-2 flex-1 text-sm leading-relaxed text-slate-500 dark:text-slate-400">{service.description}</p>
                <button
        ...
        <Reveal delay={0.2}>
          <div className="mt-16 rounded-3xl bg-gradient-to-br from-primary-800 to-primary-950 p-8 text-center sm:p-12">
            ...
            <p className="mt-3 text-slate-300">Book a free 30-minute call and we will guide you.</p>
            <button onClick={() => navigate('/booking')} className="btn-gold mt-7">
