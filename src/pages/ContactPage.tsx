...
const details = [
  {
    icon: Mail,
    label: "Email",
    value: "service@miaacademy.com",
    href: "mailto:service@miaacademy.com",
  },
  {
    icon: Phone,
    label: "Phone",
...
export default function ContactPage() {
  ...
  useEffect(() => {
    document.title = "Contact Us - StudyingGermany.de";
  }, []);
            ...
            >
              ...
              {status === "sent" && (
                <div className="mt-4 flex items-center gap-2 rounded-xl bg-success/10 px-4 py-3 text-sm text-success">
                  <CheckCircle2 className="h-4 w-4" /> Thanks! We will be in
                  touch shortly.
                </div>
              )}
              {status === "error" && (
